...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        :param previous_hash: <str> hash of prev block (optional)
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        :param sender: <str> address
        :param recipient: <str> address
        :param amount: <int> amounnt
    ...
    def proof_of_work(self, last_proof):
        """
        Simple pow - find a number p such that pp` contains leading 4 zeros
        p is the previous proof, p` is new proof
